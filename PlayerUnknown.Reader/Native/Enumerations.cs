namespace PlayerUnknown.Reader.Native
{
    ...
    public enum ThreadContextFlags
    {
        ...
        /// </summary>
        Control = ThreadContextFlags.Intel386 | 0x01,

        /// <summary>
        /// AX, BX, CX, DX, SI, DI
        /// </summary>
        Integer = ThreadContextFlags.Intel386 | 0x02,

        /// <summary>
        /// DS, ES, FS, GS
        /// </summary>
        Segments = ThreadContextFlags.Intel386 | 0x04,

        /// <summary>
        /// 387 state
        /// </summary>
        FloatingPoint = ThreadContextFlags.Intel386 | 0x08,

        /// <summary>
        /// DB 0-3,6,7
        /// </summary>
        DebugRegisters = ThreadContextFlags.Intel386 | 0x10,

        /// <summary>
        /// CPU specific extensions
        /// </summary>
        ExtendedRegisters = ThreadContextFlags.Intel386 | 0x20,

        /// <summary>
        /// All flags excepted FloatingPoint, DebugRegisters and ExtendedRegisters. 
        /// </summary>
        Full = ThreadContextFlags.Control | ThreadContextFlags.Integer | ThreadContextFlags.Segments,

        /// <summary>
        /// All flags.
        /// </summary>
        All = ThreadContextFlags.Control | ThreadContextFlags.Integer | ThreadContextFlags.Segments | ThreadContextFlags.FloatingPoint | ThreadContextFlags.DebugRegisters | ThreadContextFlags.ExtendedRegisters
    }
    ...
    public enum WindowsMessages : uint
    {
        ...
        /// Note  The WM_WININICHANGE message is provided only for compatibility with earlier versions of the system. Applications should use the WM_SETTINGCHANGE message.
        /// </summary>
        SettingChange = WindowsMessages.WinInitChange,
        ...
        /// </summary>
        CplLaunch = WindowsMessages.User + 0x1000,

        /// <summary>
        /// The WM_CPL_LAUNCHED message is sent when a Control Panel application, started by the WM_CPL_LAUNCH message, has closed. The WM_CPL_LAUNCHED message is sent to the window identified by the wParam parameter of the WM_CPL_LAUNCH message that started the application.
        /// </summary>
        CplLaunched = WindowsMessages.User + 0x1001,
